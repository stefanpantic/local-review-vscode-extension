...
- **Clicking an other-branch review** sets *that branch's* current pointer (no visible change until you're on it) — use **Move to current branch** to actually bring it here and re-anchor.
